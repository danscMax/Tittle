...
namespace Tittle.Core.Diagnostics;
...
public static class SingleInstanceMessage
{
    ...
    public static string MutexName(string userName) => $"Tittle.{Sanitize(userName)}.mutex";

    public static string PipeName(string userName) => $"Tittle.{Sanitize(userName)}.pipe";
