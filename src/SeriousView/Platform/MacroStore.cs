...
/// <summary>File-backed macro library at <c>%AppData%/SeriousView/macros.json</c> (via
...
public sealed class MacroStore : IMacroStore
{
    ...
    // Test seam: an explicit file path (the default targets %AppData%/SeriousView/macros.json).
