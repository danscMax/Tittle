...
Avalonia.Svg.Skia). Verified live against kroki.io. **HTML-export of diagrams** deliberately deferred
(fence stays code in the self-contained export — a Kroki `<img>` GET-URL is a future follow-up).
...
**(c) HTML-export of diagrams** (embed a Kroki GET-URL `<img>` in the self-contained export).
